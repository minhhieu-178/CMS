...
const TestimonialsSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
        ...
        <p className='md:text-base text-gray-500 mt-3'>Hear from our learners as they share their journeys of transfoemation,
        ...
        <div className='grid grid-cols-auto gap-8 mt-14'>
          {dummyTestimonial.map((testimonials, index)=>(
            ...
            pb-6 rounded-lg bg-white shadoe-[0px_4px_15px_0px] shadow-black/5
            overflow-hidden'>
              ...
              <div className='p-5 pb-7'>
                  <div className='flex gap-0.5'>
                      {[...Array(5)].map((__,i)=>(
                        <img className='h-5' key={i} src={i < Math.floor(testimonials.rating) ? assets.
